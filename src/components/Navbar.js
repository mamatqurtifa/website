        ...
        <div className="bg-blue-950/90 backdrop-blur-md rounded-2xl border border-blue-700/60 px-6 py-3 shadow-xl">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a
                href="#"
                className="text-blue-300 font-medium hover:text-blue-200 transition-all duration-300 relative group"
              >
          ...
          {isOpen && (
            <div className="md:hidden mt-4 pt-4 border-t border-blue-700/50 animate-fadeIn">
              <div className="flex flex-col space-y-3">
                <a
                  href="#"
                  className="text-blue-300 font-medium hover:text-blue-200 transition-all duration-300 p-2 rounded-lg hover:bg-blue-800/30 flex items-center space-x-3"
                >
                  <svg
                    className="w-4 h-4"
                    fill="currentColor"
                ...
                <a
                  href="#"
                  className="text-gray-300 hover:text-white transition-all duration-300 p-2 rounded-lg hover:bg-blue-800/30 flex items-center space-x-3"
                >
                  <svg
                    className="w-4 h-4"
                    fill="currentColor"
